...
const MainMenu = ({ dataMenu, navbarOpen, navbarToggleHandler }) => {
  ...
  return (
    <nav
      id="navbarCollapse"
      className={`navbar ease fixed z-[1000] mr-[100px] 2xl:mr-0 right-0 bottom-0 w-full border-body-color/50 bg-white
       ...
       max-[1200px]:overflow-y-auto top-[68px] sm:top-[78px] xl:visible xl:static xl:w-auto xl:border-none
        ...
        `}
    >
      <ul className="block xl:min-w-[625px] mb-[100px] xl:mb-0 xl:py-3 2xl:min-w-[780px] items-center xl:flex xl:space-x-[20px]">
              ...
              <>
                ...
                {menuItem?.children.length > 0 ? (
                  <span
                    ...
                    className={`flex w-full  cursor-pointer py-2 items-center justify-between text-base font-bold uppercase text-white group-hover:text-[green] dark:text-white xl:mr-0 xl:inline-flex xl:px-0 xl:text-[12px] xl:text-dark 2xl:text-base`}
                  >
                    {menuItem.title}
                  ...
                  <Link
                    ...
                    className={`pointer text-white flex cursor-pointer py-2 text-base font-bold uppercase group-hover:text-[green] dark:text-white lg:mr-0 lg:inline-flex xl:my-2.5 lg:px-0 xl:text-[12px] xl:text-dark 2xl:text-base`}
                  >
                    {menuItem.title}
                  </Link>
                )}
