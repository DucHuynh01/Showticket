...
const OpenTimes = ({ fontTitle }: { fontTitle?: string; }) => {
  ...
  return (
    <div className='w-full mt-4 xs:mt-8  '>
      <div className='container  max-w-full flex flex-col sm:max-w-screen-xl gap-3'>
        ...
        <div className='flex md:flex-row flex-col gap-8 md:gap-3'>
          ...
          {/* </div> */}
          <div className=' flex-flex-col border-[1px] border-gray-300 shadow-lg bg-[#eff1ee] w-full md:w-[60%] rounded-xl'>
            <div className='flex w-full flex-col md:flex-row text-black  p-4 justify-between '>
              <div className='md:w-1/2 p-2 rounded-tl-xl rounded-bl-xl '>
                <div className='text-center  z-[1000]'>
                  <div className='uppercase text-lg sm:text-2xl font-bold'>3i company</div>
                  <div className=' underline text-xs sm:text-sm'>3i.com.vn</div>
                </div>
                <div className="pt-8  text-base font-medium  px-4  flex gap-2 flex-col justify-center items-start">
                  <div className=" ml-1.5 flex justify-start gap-6 items-center">
                    <div className=''><Icon icon="carbon:phone-filled" className='text-blue-500 text-[22px]' /> </div>
                    <div className='text-[#222222D1] text-sm sm:text-sm font-semibold'>024328698</div>
                  </div>
                  <div className=" flex justify-start gap-5 items-center">
                    <div className=''><Icon icon="bx:map" className='text-blue-500 text-[30px]' /></div>
                  ...
                  <div className="flex ml-1.5 justify-start gap-6 items-center">
                    <div className=''><Icon icon="ic:round-email" className='text-blue-500 text-[25px]' /></div>
