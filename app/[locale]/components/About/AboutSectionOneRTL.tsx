              ...
              <div className="text-base !leading-relaxed text-body-color mt-[50px]">
                <div className="flex flex-col items-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  ...
                  <Link
                    ...
                    className="rounded-md bg-white hover:opacity-70 py-4 px-8 text-base font-semibold text-black duration-300 ease-in-out dark:bg-white/20 dark:text-white dark:hover:bg-white/80"
                  >
                    Nhận tư vấn
                  </Link>
                </div>
